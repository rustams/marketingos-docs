...
description: "Что такое MarketingOS, какие разделы появятся в Битрикс24 после установки и как связаны кампании, контент, медиафайлы и аналитика."
---
...
— копирайтер;\
— дизайнер;\
— подрядчик, который участвует в подготовке материалов.
...
— создать кампанию;\
— добавить заявку на контент;\
— запустить материал в производство;\
— назначить ответственного;\
— контролировать статус подготовки;\
— добавить медиафайлы;\
— вручную зафиксировать публикацию;\
— внести базовые результаты.
...
— автоматической публикации материалов;\
— сквозной аналитики;\
— аналитических панелей;\
— интеграций с рекламными кабинетами;\
