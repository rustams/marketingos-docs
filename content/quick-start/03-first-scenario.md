# Первый сценарий: от кампании до результата
...
Используйте эту статью после установки приложения, если хотите быстро понять, как связаны основные части системы.
...
Если данных недостаточно, дополните заявку до передачи в производство.
...
Если точных данных пока нет, можно вернуться к этому шагу позже.
