...
7. **Администрирование** — установка, повторная установка, удаление и решение проблем.
8. **Глоссарий и поддержка** — быстро найти ответы на частые вопросы.
...
- Администратор: [Установка приложения](admin/01-installation.md)
- Если возникла проблема: [Решение проблем](admin/04-troubleshooting.md)
